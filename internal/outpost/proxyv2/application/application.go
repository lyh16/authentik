...
func NewApplication(p api.ProxyOutpostConfig, c *http.Client, cs *ak.CryptoStore, ak *ak.APIController) (*Application, error) {
	...
	oauth2Config := oauth2.Config{
		...
		RedirectURL:  urlJoin(p.ExternalHost, "/goauthentik.io/callback"),
	...
	mux.HandleFunc("/goauthentik.io/start", a.handleRedirect)
	mux.HandleFunc("/goauthentik.io/sign_in", a.handleRedirect)
	mux.HandleFunc("/goauthentik.io/callback", a.handleCallback)
	mux.HandleFunc("/goauthentik.io/sign_out", a.handleSignOut)
	switch *p.Mode {
